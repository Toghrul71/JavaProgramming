...
public class Student {
    public String name; // instance variables/ different students have different names
    public char gender;
    public int age;
    public int studentID;
    public char grade;

    public Student(String name){  // method overloading parameters cant be same
        this.name=name;
    }
